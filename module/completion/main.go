...
var subGetCmd = &cli.Command{
	...
	Commands: []*cli.Command{
		{
			Name:  "json",
			Usage: "Get json value from key",
			Flags: []cli.Flag{
				&cli.StringFlag{
					Name:  "full",
					Usage: "get full keys json",
				},
			},
			Action: execAction,
		},
...
var subDelCmd = &cli.Command{
	Name:  "del",
	Usage: "Del value",
	Commands: []*cli.Command{
		{
			Name:  "json",
			Usage: "Delete json value from key",
			Flags: []cli.Flag{
				&cli.StringFlag{
					Name:  "recursive",
					Usage: "delete with recursive values",
				},
			},
			Action: execAction,
		},
